...
<script>
	var resizeFrames = function(flowChartHeight) {
		var maxHeight = 900;
		if($("#contentsFrame").height() < maxHeight) {
			$("#contentsFrame").css("height", document.body.scrollHeight);
		} else {
			$("#contentsFrame").css("height", maxHeight);
		}
		$("#contentsFrame").contents().find("#instanceListFrame").css("height", $("#contentsFrame").height() - 50);
		$("#contentsFrame").contents().find("#instanceListFrame").contents().find("#flowchartFrame").css("height", flowChartHeight);
	}
	...
	$(document).ready(function() {
		...
		$(document).click(function(){
			if (selectedNode && selectedNode.type && isTreeClick){
