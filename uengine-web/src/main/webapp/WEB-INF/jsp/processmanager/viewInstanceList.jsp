...
<script>
	...
	$(document).ready(function() {
		...
		$("#instanceListFrame").load(resizeFrameHeight);
	});
...
<body style="overflow:hidden">
	...
	<form:form name="instanceForm" id="instanceForm" action="" method="post" target="instanceListFrame">
		...
		<form:input path="status" type="hidden" id="status" name="status" value="${status}" />
		<form:input path="searchResult" type="hidden" id="searchResult" name="searchResult" value="${searchResult}" />
