...
<script>
	var fn_setGrid = function() {
		...
		$("#instanceListGridTable").jqGrid({
			...
			ondblClickRow: function(rowId){
				...
				// 20190222 skk
				$("#status").val($(this).getRowData(rowId).status);
	...
	$(document).ready(function() {
		...
		// 로딩 메시지
		$("#instanceListGridTable > tbody:first").append("<tr><td colspan='12'><div style='font-size: 2.0em;' >&nbsp조회중...</div></td><tr>");
		
		//상세페이지에서 안보이게했던 검색창 복구
		parent.$("#content-middle").show();
