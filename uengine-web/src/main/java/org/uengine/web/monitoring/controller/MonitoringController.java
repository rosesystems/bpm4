...
public class MonitoringController {
	...
	@RequestMapping(value="/monitoring/processingdelaystatus", method = RequestMethod.POST)
	@ResponseBody
	public JSONObject getProcessingDelayStatusData(HttpServletRequest request) throws Exception{
		@SuppressWarnings("unchecked")
		Map<String, String> map = new HashedMap();
		if(UEngineUtil.isNotEmpty(request.getParameter("partCode"))){
			map.put("partCode", request.getParameter("partCode"));	
        ...
        return (JSONObject)monitoringService.getProcessingDelayStatusData(map);
    }
